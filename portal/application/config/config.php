<?php
/**
 * 파일 위치: application/config/config.php
 * 역할: 포털 전역 설정 (환경변수 기반)
 */
...
|
*/
$config['base_url'] = env('APP_BASE_URL', 'http://localhost:8080/');
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
...
|
*/
$config['log_threshold'] = (env('APP_ENV') === 'development') ? 4 : 1;
/*
|--------------------------------------------------------------------------
...
|
*/
$config['encryption_key'] = hex2bin(env('ENCRYPTION_KEY', str_repeat('0', 64)));
/*
|--------------------------------------------------------------------------
| Session Variables
|--------------------------------------------------------------------------
...
$config['csrf_exclude_uris'] = array('api/launcher/.*', 'api/relay/.*');
/*
|--------------------------------------------------------------------------
| Output Compression
|--------------------------------------------------------------------------
