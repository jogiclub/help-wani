  ...
  <div class="card-body space-y-6">
    ...
    <div class="flex gap-4">
      ...
      <div>
        ...
        <div class="text-sm text-slate-500">Microsoft Store 에서 무료로 설치합니다.</div>
        <div class="mt-3 flex flex-wrap gap-2">
          <a class="btn btn-primary btn-sm" href="<?= html_escape($store_app_url) ?>">Microsoft Store 에서 받기</a>
    ...
    <div class="flex gap-4">
      ...
      <div>
        ...
        <div class="text-sm text-slate-500">이미 설치했다면 아래 버튼으로 바로 실행합니다.</div>
        <div class="mt-3">
          <a class="btn btn-success btn-sm" href="<?= html_escape($protocol_url) ?>">이미 설치했어요 (앱 열기)</a>
        </div>
      </div>
    </div>
    ...
    <div class="flex gap-4">
      ...
      <div>
        ...
        <div class="text-sm text-slate-500">상담원이 전화로 알려준 6자리 숫자를 앱에 입력하면 연결됩니다.</div>
      </div>
    </div>
