  ...
  <div class="card-body">
    <div class="flex gap-4">
      ...
      <div class="min-w-0 flex-1">
        <div class="font-semibold text-slate-800">원격지원 프로그램 받기</div>
        <div class="mt-1 text-sm text-slate-500">
          아래 버튼을 눌러 프로그램을 내려받은 뒤 실행해 주세요. 설치 과정은 없습니다.
        </div>

        <?php if ($download_info): ?>
          <a class="btn btn-primary btn-lg mt-3 w-full sm:w-auto" href="<?= html_escape($download_url) ?>">
            원격지원 프로그램 다운로드 (Windows)
          </a>
          <div class="form-help">
        ...
        <?php else: ?>
          <div class="alert alert-info mt-3">
            프로그램 배포 파일을 준비 중입니다. 상담원에게 문의해 주세요.
          </div>
        <?php endif; ?>

        <div class="mt-3 border-t border-slate-100 pt-3">
          <div class="text-xs text-slate-500">Microsoft Store 에서 설치할 수도 있습니다.</div>
          <div class="mt-2 flex flex-wrap gap-2">
            <a class="btn btn-secondary btn-sm" href="<?= html_escape($store_app_url) ?>">Store 에서 받기</a>
            <a class="btn btn-secondary btn-sm" href="<?= html_escape($store_web_url) ?>" target="_blank" rel="noopener">웹에서 열기</a>
          </div>
        </div>
      </div>
    </div>
...
<div class="card mt-3">
  <div class="card-body">
    <div class="flex gap-4">
      ...
      <div>
        <div class="font-semibold text-slate-800">프로그램 실행</div>
        <div class="mt-1 text-sm text-slate-500">
          내려받은 파일을 두 번 눌러 실행합니다.
          Store 에서 설치했다면 아래 버튼으로 바로 열 수 있습니다.
        </div>
        <a class="btn btn-success btn-sm mt-3" href="<?= html_escape($protocol_url) ?>">이미 설치했어요 (앱 열기)</a>
      </div>
    </div>
  </div>
</div>
...
<div class="card mt-4">
  <div class="card-body text-sm text-slate-500">
    ...
    <ul class="list-disc space-y-1 pl-5">
      ...
      <li>프로그램은 상담이 끝나면 어떠한 구성요소도 컴퓨터에 남기지 않습니다.</li>
