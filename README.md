...
| 3 | 고객 런처 | 코드 작성 완료, 윈도우 빌드/실행 미검증 |
...
2. UltraVNC 바이너리 배치 (`launcher/vendor/README.md`)
3. 실서버와 도메인, Let's Encrypt 인증서 (`server/README.md`)
4. Partner Center 계정과 앱 이름 예약 (`docs/store-submission.md`)
